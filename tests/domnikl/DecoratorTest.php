...
use Patterns\Structural\Decorator\Domnikl\DoubleRoomBooking;
use Patterns\Structural\Decorator\Domnikl\ExtraBed;
use Patterns\Structural\Decorator\Domnikl\SingleRoomBooking;
use Patterns\Structural\Decorator\Domnikl\WiFi;
use PHPUnit\Framework\TestCase;

class DecoratorTest extends TestCase {

	public function testCanCalculatePriceForBasicSingleRoomBooking() {
	...
	public function testCanCalculatePriceForSingleRoomBookingWithWiFiAndExtraBed() {
		$booking = new SingleRoomBooking();
		$booking = new WiFi($booking);
		$booking = new ExtraBed($booking);
		$this->assertSame(62, $booking->calculatePrice());
		$this->assertSame('single room with wifi with extra bed', $booking->getDescription());
	}
